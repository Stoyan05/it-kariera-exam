    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Console.WriteLine(Input.FirstName + " " + Input.LastName + " " + Input.Username);
                result = await _userServices.CreateAccountAsync(Input.FirstName, Input.LastName, Input.Username, Input.Password, Roles.User);
                ...
                if (result.Item1.Succeeded)
                {
                    ...
                    //await _signInManager.PasswordSignInAsync(user, Input.Password, lockoutOnFailure: true);
                    ...
                    // Else if you want to validate credentials here, with signInManager:
                    Console.WriteLine("Sq sum tukaaaa" + userId);
                    if (user != null)
                    {
